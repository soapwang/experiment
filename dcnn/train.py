...
# print(x_)
# print("123123123",len(vocabulary))
...
Wh = init_weights([top_k*int(embed_dim*num_filters[1]/4), num_hidden], "Wh")
print("Wh:",Wh)
...
out, l2_loss = model.DCNN(input_x, W1, W2, b1, b2, k1, top_k, Wh, bh, Wo, dropout_keep_prob)

with tf.name_scope("cost"):
    cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=out, labels=y))
    loss = cost + 2.0 * l2_loss
