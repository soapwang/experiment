...
yelp_small = 50000
yelp_large = 250000
yelp = "C:/Users/Soapwang/PycharmProjects/datasets/yelp_250k"

def load_yelp(alphabet):
    examples = []
    labels = []
    with codecs.open(yelp, "r", "utf-8") as f:
        i = 0
        j = 0
        for line in f:
...
def load_data():
    ...
    alphabet = "abcdefghijklmnopqrstuvwxyz0123456789-,;.!?:'\"/\\|_@#$%^&*~`+-=<>()[]{}\n"
    examples, labels = load_yelp_full(alphabet)
