...
imdb_train = ["C:/Users/Soapwang/PycharmProjects/datasets/aclimdb/imdb_train_pos_ansi.txt",
              "C:/Users/Soapwang/PycharmProjects/datasets/aclimdb/imdb_train_neg_ansi.txt"]
imdb_test = ["C:/Users/Soapwang/PycharmProjects/datasets/aclimdb/imdb_test_pos_ansi.txt",
             "C:/Users/Soapwang/PycharmProjects/datasets/aclimdb/imdb_test_neg_ansi.txt"]
...
tf.flags.DEFINE_string("yelp_file", "C:/Users/Soapwang/PycharmProjects/datasets/yelp_250k", "Data source for yelp reviews.")
...
tf.flags.DEFINE_integer("evaluate_every", 1700, "Evaluate model on dev set after this many steps (default: 100)")
...
if is_imdb:
    ...
    x_train, y_train = data_helpers.load_imdb_train(imdb_train)
    x_test, y_test = data_helpers.load_imdb_test(imdb_test)

    # max length:about 2500
    # average length: 231
    # length median: 173
    ...
    y_dev = y_test[shuffle_indices]
    x_dev= x_test[shuffle_indices]
    ...
    x_text, y = data_helpers.load_yelp_polarity(FLAGS.yelp_file, small_data)
    ...
    dev_sample_index = int(len(x_shuffled) * 0.9)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def dev_step(x_batch, y_batch, writer=None):
            ...
            max_batch_size = 1000 # imdb 1000 = OOM
            ...
            for i in range(len(acc)):
                print("test batch %d acc %f" % (i, acc[i]))
